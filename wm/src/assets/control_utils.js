      ...
      */
      ...
      t("Promise", function (a) {
        ...
        b.prototype.G = function (e) {
          if (e === this) this.l(new TypeError("A Promise cannot resolve to itself"));else if (e instanceof b) this.I(e);else {
            a: switch (typeof e) {
              case "object":
                var h = null != e;
                break a;
      ...
      if (z) z(M, N);else for (var O in N) if ("prototype" != O) if (Object.defineProperties) {
          ...
          return L(a, function f() {
            ...
            return I(f, function (n) {
              if ((g = c.files) && 0 < g.length) {
                ...
                if (URL && URL.createObjectURL) u = new M(URL.createObjectURL(u), na);else throw Error("cannot find createObjectURL");
                k = u.toString();
