System.register("chunks:///_virtual/AR_Track.ts", ['./_rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _defineProperty, _asyncToGenerator, cclegacy, _decorator, EventHandler, CCString, CCBoolean, find, view, v3, Component, UITransform;
    ...
    execute: function () {
      ...
      var AR_Track = exports('AR_Track', (_dec = ccclass('AR_Track'), _dec2 = property({
        ...
        function AR_Track() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "isWeChat", _descriptor3, _assertThisInitialized(_this));
                  ...
                  case 0:
                    ...
                    constraints = {
                      'video': {
                        ...
                        width: this.isWeChat ? winSize.height : winSize.width,
                        height: this.isWeChat ? winSize.width : winSize.height
                      },
                      'audio': false
                    };
                    _context3.next = 5;
        ...
        _proto.getmark = function getmark(event) {
          ...
          if (event.data.type === globalThis.artoolkit.PATTERN_MARKER && event.data.marker.cfPatt > 0.6) {
            ...
            find('Canvas/Node/star').position = this.getTrackPos(event.data.marker.pos);
        ...
        _proto.getTrackPos = function getTrackPos(pos) {
          var rate = view.getVisibleSize().width / view.getCanvasSize().width;
          return v3(pos[0] * rate, pos[1] * rate, 0);
        };
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "isWeChat", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
  ...
  return {
    ...
    execute: function () {
      ...
      var AR_Recognition = exports('AR_Recognition', (_dec = ccclass('AR_Recognition'), _dec2 = property({
        ...
        displayName: 'marker Path',
        type: [CCString]
      }), _dec4 = property(CCBoolean), _dec5 = property(CCBoolean), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function AR_Recognition() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "isWeChat", _descriptor4, _assertThisInitialized(_this));
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "isWeChat", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
